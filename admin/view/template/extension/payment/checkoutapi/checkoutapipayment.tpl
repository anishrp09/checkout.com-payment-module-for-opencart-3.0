...
<div class="panel-body">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-checkoutapipayment" class="form-horizontal">
        ...
        <div class="form-group ">
            ...
            <div class="col-sm-10">
                <input type="text" name="checkoutapipayment_gateway_timeout" value="<?php echo $checkoutapipayment_gateway_timeout; ?>" id="input_gateway_timeout" class="form-control" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label" for="input-order-status"><?php echo $entry_successful_order_status; ?></label>
            <div class="col-sm-10">
                <select name="checkoutapipayment_checkout_successful_order"  class="form-control">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="input-order-status"><?php echo $entry_flagged_order_status; ?></label>
            <div class="col-sm-10">
                <select name="checkoutapipayment_checkout_flagged_order"  class="form-control">
                    <?php foreach($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $checkoutapipayment_checkout_flagged_order) { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    <?php } ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select name="checkoutapipayment_checkout_failed_order"  class="form-control">
                    <?php foreach($order_statuses as $order_status) { ?>
